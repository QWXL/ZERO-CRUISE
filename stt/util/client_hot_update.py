...
path_zh = Path(ClientConfig.folderHotWords) / "hot-zh.txt"
path_en = Path(ClientConfig.folderHotWords) / "hot-en.txt"
path_rule = Path(ClientConfig.folderHotWords) / "hot-rule.txt"
path_kwds = Path(ClientConfig.folderHotWords) / "keywords.txt"
